...
async function cargarInventario() {
    ...
    if (error) {
        ...
        // Aunque falle Supabase,
        // el catálogo debe seguir funcionando
        mostrarProductos();
...
// Mostrar inmediatamente las marcas
mostrarMarcas();

// Mostrar inmediatamente los productos
mostrarProductos();

// Cargar inventario después
cargarInventario();
