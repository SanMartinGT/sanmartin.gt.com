...
/* =========================================================
   SAN MARTÍN — ABRIR / CERRAR VENTANA MI CUENTA
========================================================= */

const cuentaOverlay =
    document.getElementById("cuentaOverlay");

const btnAbrirCuenta =
    document.getElementById("btnAbrirCuenta");
...
if (btnAbrirCuenta && cuentaOverlay) {

    btnAbrirCuenta.addEventListener(
        "click",
        () => {

            cuentaOverlay.hidden = false;
            ...
            /*
             * Si no hay una vista activa,
             * mostramos el acceso principal.
             */
