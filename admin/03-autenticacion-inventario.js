...
logoutButton.addEventListener(
    ...
    async () => {
        ...
        if (
            typeof actualizarEstadisticasPedidos ===
            "function"
        ) {
...
/* =====================================================
   ESC PARA CERRAR MODAL DE PRODUCTO
===================================================== */
...
productForm.addEventListener(
    ...
    async evento => {
        ...
        const codigo =
            productCodigo.value.trim();

        const nombre =
            productNombre.value.trim();

        const marca =
            productMarca.value.trim();

        const categoria =
            productCategoria.value.trim();

        const descripcion =
            productDescripcion.value.trim();

        const precioTexto =
            productPrecio.value.trim();

        const stockTexto =
            productStock.value.trim();

        const stockMaximoTexto =
            productStockMaximo.value.trim();

        const ofertaTexto =
            productOferta.value.trim();
...
productImagenes.addEventListener(
    "change",
            ...
            item.innerHTML = `
                ...
                <div class="image-preview-actions">
                    ...
                    <button
                        ...
                        onclick="hacerImagenPrincipal(${Number(
                            imagen.id
                        )})"
                    >
                        ⭐
                    ...
                    <button
                        ...
                        class="image-action-button"
                        title="Subir"
                        onclick="subirImagenOrden(${Number(
                            imagen.id
                        )})"
                    >
                        ⬆️
                    ...
                    <button
                        ...
                        class="image-action-button"
                        title="Bajar"
                        onclick="bajarImagenOrden(${Number(
                            imagen.id
                        )})"
                    >
                        ⬇️
                    ...
                    <button
                        ...
                        title="Eliminar"
                        onclick="eliminarImagenExistente(${Number(
                            imagen.id
                        )})"
                    >
                        🗑️
...
function ocultarVistaPreviaImagenes() {
    ...
    imagesPreviewContainer.classList.add(
        "hidden"
    );
}
